...
sd_frac = 0 # In the random initialization, how to move away from the std
            ...
            for num_finetune_epochs in nums_finetune_epochs:
                ...
                for s in range(number_snapshots):
                    ...
                    if s == 0:
                        ...
                        model = HolE(triples_factory=training_triples_factory, embedding_dim=emb_dimension, random_seed = 8128).to(device)
