...
class TrainDatasetMarginLossIncDE(Dataset):
    def __init__(self, args, kg):
        super(TrainDatasetMarginLossIncDE, self).__init__()
        self.args = args
        self.kg = kg
        self.facts, self.facts_new = self.build_facts()
...
class TestDatasetIncDE(Dataset):
    def __init__(self, args, kg):
        super(TestDatasetIncDE, self).__init__()
        self.args = args
        self.kg = kg
