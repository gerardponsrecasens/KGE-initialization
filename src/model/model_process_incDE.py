...
class RetrainBatchProcessorincDE():
    def __init__(self, args, kg):
        self.args = args
        self.kg = kg  # information of snapshot sequence
        '''prepare data'''
        self.dataset = TrainDatasetMarginLossIncDE(args, kg)
...
class TrainBatchProcessorincDE():
...
class DevBatchProcessorincDE():
    def __init__(self, args, kg) -> None:
        self.args = args
        self.kg = kg
        self.batch_size = 100
        """ prepare data """
        self.dataset = TestDatasetIncDE(args, kg)
        self.data_loader = DataLoader(self.dataset,
                                      shuffle=False,
